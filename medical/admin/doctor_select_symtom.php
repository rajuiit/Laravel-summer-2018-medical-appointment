...
$id = $_GET['id'];
$result=mysqli_query($con,"select name,doctor_id from doctor_info ");
...
$result = mysqli_query($con, "insert into symptom_doctor(doctor_id,symptom_id) values('$doctor_id','$symptom_id')");
    if($result){
             ...
             <label for="doctor_id">Doctor name :</label>
              <select class="form-control form-control-sm"  name="doctor_id" >
                ...
                while($res = mysqli_fetch_array($result))
                   {?>
                   <option value="<?php echo $res['doctor_id']; ?>"><?php echo $res['name']; ?></option>
                   <?php }
                ?>
            </select>
            </div>
