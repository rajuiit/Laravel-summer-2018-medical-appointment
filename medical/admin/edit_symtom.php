...
$id = $_GET['id'];
$result = mysqli_query($con, "SELECT * FROM symptom WHERE symptom_id='$id'");
$result2 = mysqli_query($con, "SELECT DISTINCT symptom_type FROM symptom");
while($res = mysqli_fetch_array($result))
{
	$symtom_name = $res['symptom_name'];
...
$result = mysqli_query($con, "UPDATE symptom SET symptom_name='$symtom_name',symptom_type='$symtom_type' WHERE symptom_id='$id'");
    if($result){
        ...
        <div class="container-fluid">
          ...
          <hr>
           ...
           <form action="" method="post">
            ...
            <input class="form-control form-control-sm" type="text" name="symtom_name" value="<?php echo $symtom_name;?>">
